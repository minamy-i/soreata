...
## 暗黙ルール理解力（言葉にされていない約束ごとを知る能力）
競争を理解し、「相手を遅らせれば勝てる」という戦略的思考があった。さらに「なんでみんなは協力してくれないのか」とまで思っていた。足りなかったのは「相手チームのエリアに立ち入らない」という暗黙のルールだった。
...
この課題を実行するために必要な能力を分解してください。
各能力の名前は「〜力」の形で平易に表記してください。
各能力に対する対応方法も提案してください。
