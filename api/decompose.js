...
走り回っているのは、前庭覚（身体が動くときに得られる感覚）を求めているからである。この欲求が満たされないまま注目を指示しても効果はない。「静止させる」のではなく「欲求を先に満たす」ことで、自然に注意が外へ向かう。
対応：先生が抱っこして揺らすなど、前庭覚を先に満たしてから注目を促す。`;
...
各能力の名前は「〜力」の形で表記する。
各能力に対して、この課題を実行する本人が無理なくできる手段や代替手段を提案する。
そのために必要な周りの支援も提案する。
