...
graph LR
    ...
    class ROOT,APP,APP_PAGE,APP_LAYOUT,APP_CSS,APP_LOGIN,LOGIN_PAGE,APP_ACCOUNT,ACCOUNT_PAGE,APP_AUTH,AUTH_ROUTE,APP_API,API_DECOMPOSE,API_INVITE,API_WEBHOOK,APP_COMPONENTS,COMP_NAV,COMP_ABILITY,COMP_CONFIRM,APP_HOME,TEAM_PAGE,HOME_RECORD,RECORD_PAGE,RECORD_DETAIL,HOME_SETTINGS,SETTINGS_PAGE,SETTINGS_FORM appStyle
    class LIB,LIB_ABILITY,LIB_APIRES,LIB_PROMPT,LIB_RECORDTEXT,LIB_REQUIREMEMBER,LIB_SBADMIN,LIB_SBBROWSER,LIB_SBSERVER,LIB_TEAMDELETE,LIB_TEAMDISPLAY,LIB_TEAMEMPTY,LIB_TEAMMEMBERS,LIB_USEACCORDION,LIB_USESESSION libStyle
    ...
    class PKGJSON,PKGLOCK,NEXTCONFIG,NEXTENVD,TSCONFIG,TSBUILDINFO,VERCELJSON,VERCELDIR,ENVFILES,CLAUDEMD otherStyle
